...
void select_lambda(double *abs_cross_product, unsigned int p, double alpha, double lambda_ratio, double *lambda,
                   unsigned int n_lambda, unsigned int max_nonzero);
